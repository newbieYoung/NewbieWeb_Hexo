...
![图 1.2.2-1.jpg](./images/chapter1/1.2.2-1.jpg)

这种默认方式确定的坐标系被称为右手坐标系，是因为它可以通过上图所示的右手手势确定，当你伸出右手摆出如图所示手势时，拇指指向 X 轴的正方向，食指指向 Y 轴的正方向，中指指向 Z 轴的正方向，这种确定坐标系方式也被称为右手定则。
